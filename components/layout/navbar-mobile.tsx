  ...
  return (
    ...
    >
      <button
        ...
        className={cn(
          "absolute inset-0 bg-text/25 transition-opacity",
      ...
      <aside
        className={cn(
          "absolute right-0 top-0 h-full w-full max-w-md overflow-y-auto border-l border-border bg-surface shadow-lg transition-transform",

...
export function NavbarMegaMenu({ item, isOpen, onClose }: NavbarMegaMenuProps) {
  ...
  return (
    <div
      className={cn(
        "pointer-events-none absolute left-0 top-full z-40 w-full transition-all duration-200",
    ...
    >
      <div
        className={cn(
          "w-screen border-y border-border bg-surface shadow-md transition-all duration-200",
